...
export const mockPosts: MockPost[] = [
  {
    ...
    contentText:
      'Today’s desk reset: one notebook, a clear hour, and no pressure to make the first sentence impressive.\n\nSmall rituals make returning to the work much easier.',
    ...
    media: [
      ...
      },
      {
        ...
        alt: 'A calm view through a window into the countryside',
        mimeType: 'image/jpeg',
      },
      {
        id: 'maya-desk-5',
      ...
      },
      {
        ...
        alt: 'A weekly planner beside writing tools',
        mimeType: 'image/jpeg',
      },
      {
        id: 'maya-desk-7',
    ...
    editedAt: '2026-07-01T03:20:00.000Z',
    isFeatured: true,
  ...
  },
  {
    ...
    contentText:
      'Found a tiny bookstore on my walk this morning. No recommendations shelf, no best-seller wall—just a handwritten note inside every book the owner loved.\n\nI stayed longer than I planned.',

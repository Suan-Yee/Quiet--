...
function NewsletterCard() {
  ...
  return (
    <Card className="border-[#F3D9CB] bg-[#FFF1E8] p-5 shadow-sm shadow-[#FF6719]/10 dark:border-[var(--color-border)] dark:bg-[var(--color-soft-accent)]">
      <p className="text-xs font-semibold uppercase tracking-wide text-[var(--color-muted)]">
        Newsletter
      </p>
      <h2 className="mt-2 font-reading text-xl font-bold text-[var(--color-text)]">Weekly letter</h2>
